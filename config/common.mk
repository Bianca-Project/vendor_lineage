...
LINEAGE_VERSION := $(BIANCA)-v$(VERSION)-$(BIANCA_BUILDTYPE)-$(LINEAGE_BUILD)-$(shell date +%d%m%Y-%H%M)
LINEAGE_DISPLAY_VERSION := $(BIANCA)-v$(VERSION)-$(BIANCA_BUILDTYPE)-$(LINEAGE_BUILD)

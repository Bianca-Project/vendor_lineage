...
ALARM_PATH := vendor/bianca/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/bianca/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/bianca/prebuilt/common/media/audio/ringtones
